...
//                Toast.makeText(ModifyPage.this, "hi", Toast.LENGTH_SHORT).show();
    ...
    private TextWatcher movieInsertTextWatcher = new TextWatcher() {
        ...
        public void onTextChanged(CharSequence s, int start, int before, int count) {
            ...
            String beforerating = tvBefore.getText().toString();
            ...
            Log.d("result",beforerating);
            Log.d("result",afterrating);
            Log.d("result",beforetitle);
            Log.d("result",aftertitle);
            Log.d("result",beforegenre);
            Log.d("result",aftergenre);
            Log.d("result",beforeyear);
            Log.d("result",afteryear);
